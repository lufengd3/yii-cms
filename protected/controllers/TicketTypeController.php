...
class TicketTypeController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['TicketType']))
		{
			...
			if($model->save())
                Price::model() -> setInitPrice($model -> ticket_type_id);
				$this->redirect(array('view','id'=>$model->ticket_type_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('TicketType');
